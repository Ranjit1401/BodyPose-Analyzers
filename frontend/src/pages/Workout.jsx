...
export default function Workout() {
  ...
  // Get the exercise name for the ExerciseAnalyzer
  const getExerciseName = () => {
    if (type === "import") return "YouTube Import";
    if (exerciseMap[type]) {
      return exerciseMap[type][variationIndex]?.label || type;
    }
        ...
        {!videoId ? (
          ...
          <div className="workout-grid">
            <div className="camera-section">
              <ExerciseAnalyzer exerciseName={getExerciseName()} type={type} />
            </div>
